...
@Component({
  selector: 'app-admin-panel-list-publisher',
  templateUrl: './admin-panel-list-publisher.component.html',
  styleUrls: ['./admin-panel-list-publisher.component.scss']
})
export class AdminPanelListPublisherComponent implements OnInit {
